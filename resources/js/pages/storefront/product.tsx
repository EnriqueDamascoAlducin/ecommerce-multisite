...
export default function StorefrontProduct({
    ...
    const displayPrice = currentVariant
        ? {
              ...
              effective_price: currentVariant.is_special
    ...
    const currentGallery =
        currentVariant && currentVariant.gallery.length > 0
        ...
        <>
            ...
            <div className="grid gap-8 md:grid-cols-2">
                    ...
                    <div className="flex aspect-square items-center justify-center overflow-hidden rounded-lg bg-neutral-100 dark:bg-neutral-900">
                        {currentGallery.length > 0 ? (
                            <img
                                ...
                                alt={currentGallery[activeImage]?.alt}
                ...
                <div>
                    ...
                    <div className="mt-4 flex items-center gap-3">
                        {displayPrice.is_special &&
                        displayPrice.special_price ? (
                            <>
                                <span className="text-2xl font-bold text-red-600">
                                    {formatPrice(displayPrice.special_price)}
                                </span>
                            ...
                            <span className="text-2xl font-bold">
                                {formatPrice(displayPrice.effective_price)}
                            </span>
                        )}
                    </div>
                    ...
                    {product.short_description && (
                        <div
                            className="rich-text mt-4 text-neutral-600"
            ...
            {product.description && (
                <section className="mt-10">
                    ...
                    <div
                        className="rich-text text-neutral-600"
                        dangerouslySetInnerHTML={{
