...
export default function StorefrontHome({ featured }: { featured: ProductCardData[] }) {
    const { store } = usePage().props;

    return (
        <>
            <Head title={store ? store.store.name : 'Inicio'} />
            ...
            <section>
                ...
                {featured.length === 0 ? (
                    <p className="py-8 text-center text-neutral-500">Aún no hay productos en esta tienda.</p>
                ) : (
