...
Route::middleware(['auth', 'verified'])->prefix('admin')->name('admin.')->group(function () {
    ...
    // Multisitio: websites, tiendas y configuraci�n por scope.
    ...
    // Cat�logo: etiquetas (badges) de productos
    ...
    // Grupos de clientes (segmentaci�n por website)
    ...
    Route::middleware('permission:promotions.view')->group(function () {
        ...
        // Reglas de cat�logo (descuentos autom�ticos de precio)
    ...
    // Env�os: m�todos globales + configuraci�n por tienda
    ...
    // Encabezado: cintillo (por website) + men� del header (por tienda)
    Route::middleware('permission:settings.storefront')->group(function () {
        ...
        Route::delete('storefront/pages/{page}/stores/{store}', [StorefrontPageController::class, 'unlink'])->name('storefront.pages.unlink');
